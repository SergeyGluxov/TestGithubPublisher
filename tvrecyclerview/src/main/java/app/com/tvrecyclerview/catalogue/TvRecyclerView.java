package app.com.tvrecyclerview.catalogue;
...
import app.com.tvrecyclerview.FocusBorderView;
import app.com.tvrecyclerview.R;
...
public class TvRecyclerView extends RecyclerView {
    ...
    public void setLayoutManager(LayoutManager layoutManager) {
        if (layoutManager instanceof GridLayoutManager) {
            ...
            mNumRows = 1;
        } else if (layoutManager instanceof app.com.tvrecyclerview.ModuleLayoutManager) {
    ...
    public View focusSearch(View focused, int direction) {
        ...
        if ((mDirection == View.FOCUS_LEFT || mDirection == View.FOCUS_RIGHT)
            ...
            if (mLastFocusedView.getParent() instanceof TvRecyclerView) {
                ...
                } else if (tvRecyclerView != this && tvRecyclerView.getLastFocusedView() == null) {
                    return tvRecyclerView.getChildAt(tvRecyclerView.getFirstVisiblePosition());
                }
            }
